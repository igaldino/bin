...
apt install -y arc-theme breeze-cursor-theme flatpak fonts-ubuntu galculator git gvfs-backends lightdm-gtk-greeter-settings papirus-icon-theme redshift-gtk rsync tlp tlp-rdw unrar
